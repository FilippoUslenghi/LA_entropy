...
load(strjoin([path_to_data "LA_SR_info.mat"], '/'))
load(strjoin([path_to_data "LA_SR_mesh.mat"], '/'))
load(strjoin([path_to_data "LA_SR_points_data.mat"], '/'))
...
% vtkwrite(strjoin([data_dir, patient_ID, 'LA_SR_mesh.vtk'], '/'), 'polydata', ...
...
%     strjoin([data_dir, patient_ID, 'LA_SR_mesh.vtk'], '/'), ...
%     strjoin([data_dir, patient_ID, 'LA_SR_mesh_resampled.vtk'], '/'));
